...
String excelLocation = 'Laporan\\Laporan - add.xlsx'
String sheetNameLaporan = 'Laporan-add'

List<HashMap> listHashMapLaporan = handleTestData.readTestData(excelLocation, sheetNameLaporan, true)
for (int i = 0; i < listHashMapLaporan.size(); i++) {
	try {
		HashMap getHashMapParameter = listHashMapLaporan.get(i)
		KeywordUtil.logInfo(listHashMapLaporan.toString())
		laporan.setLaporan(getHashMapParameter)
		laporan.refreshPage()
	}catch (Exception e) {
