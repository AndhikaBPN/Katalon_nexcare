...
import dashboard.care.FilterDashboardLead
...
FilterDashboardLead lead = new FilterDashboardLead()

gAction.login("cslead")
oDashboard.open("lead")

String excelLocation = 'Dashboard\\Lead\\Filter Dashboard Lead.xlsx'
...
for(int i=0; i<listHashMapDataFilter.size(); i++) {
	try {
		...
		String newFilter = lead.setFilterLead(getHashMapDataFilter)
