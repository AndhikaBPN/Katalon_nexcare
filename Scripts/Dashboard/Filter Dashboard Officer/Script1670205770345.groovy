...
import dashboard.care.FilterDashboardOfficer
...
FilterDashboardOfficer officer = new FilterDashboardOfficer()

gAction.login("cslevel1")
oDashboard.open("officer")

String excelLocation = 'Dashboard\\Officer\\Filter Dashboard Officer.xlsx'
...
for(int i=0; i<listHashMapDataFilter.size(); i++) {
	try {
		...
		String newFilter = officer.setFilterOfficer(getHashMapDataFilter)
