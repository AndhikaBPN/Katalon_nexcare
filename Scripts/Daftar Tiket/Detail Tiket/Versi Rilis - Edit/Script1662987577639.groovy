...
String excelLocation = 'Daftar Tiket\\Detail Tiket\\VersiRilis - edit.xlsx'
String sheetName = 'Versi-edit'
...
for (int i = 0; i < listHashMapNoBug.size(); i++) {
	try {
		...
		String versiRilis = getHashMapNoBug.get('versiRilis')
		
		detailtiket.cariTiket(ticket_number)
		detailtiket.detailTiket(ticket_number)
		detailtiket.editVersiRilis(getHashMapNoBug)
