...
List<HashMap> listHashMapViewPengguna = handleTestData.readTestData(excelLocation, sheetNamePengguna, true)
for (int i = 0; i < listHashMapViewPengguna.size(); i++) {
	try {
		HashMap getHashMapViewPengguna = listHashMapViewPengguna.get(i)
		String groupID = getHashMapViewPengguna.get('groupID')
		KeywordUtil.logInfo(getHashMapViewPengguna.toString())
		String testDataNumber = getHashMapViewPengguna.get('TD')
